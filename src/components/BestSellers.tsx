...
import { BEST_SELLER_PRODUCTS } from '../types';
import ProductCard from './ProductCard';

export default function BestSellers() {
  return (
    <section className="py-16 bg-white border-t border-neutral-50">
        ...
        <div className="flex items-end justify-between mb-10">
          <div className="space-y-2">
            <h2 className="font-display text-3xl md:text-4xl font-black text-neutral-900 tracking-tight">
              BEST <span className="text-fuchsia-600">SELLERS</span>
            </h2>
            <p className="text-neutral-500 text-sm md:text-base font-medium">
              Customer favorites worth adding to your wardrobe.
            </p>
          </div>
